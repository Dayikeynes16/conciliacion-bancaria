...
const uploadPreview = async () => {
    ...
    try {
        const response = await axios.post(route("bank-formats.preview"), formData, {
...
const getTypeColor = (type) => {
    switch (type) {
        case 'fecha': return 'bg-green-100 text-green-800 border-green-300';
        case 'descripcion': return 'bg-blue-100 text-blue-800 border-blue-300';
        case 'monto': return 'bg-purple-100 text-purple-800 border-purple-300';
        case 'referencia': return 'bg-gray-100 text-gray-800 border-gray-300';
        case 'tipo': return 'bg-yellow-100 text-yellow-800 border-yellow-300';
                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <div v-else>
                            <div class="mb-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex space-x-2">
                                            <button 
                                                ...
                                                :class="{'border-gray-900 dark:border-white ring-2 ring-indigo-500': form.color === color, 'border-transparent': form.color !== color}"
                                ...
                                <div v-if="isEditing && rows.length === 0" class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg mb-6 border dark:border-gray-600">
                                ...
                                <div class="overflow-x-auto border rounded-lg dark:border-gray-700">
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        <thead class="bg-gray-50 dark:bg-gray-800">
                                            <tr>
                                                <th class="px-3 py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider sticky left-0 bg-gray-50 dark:bg-gray-800 z-10 w-12">
                                                    #
                                                </th>
                                                <th 
                                                    v-for="(cell, colIndex) in rows[0]" 
                                                    :key="colIndex"
                                                    ...
                                                    :class="isColumnSelected(colIndex) ? getTypeColor(getColumnType(colIndex)) : 'text-gray-500'"
                                                >
                                                    <div class="flex justify-between items-center mb-1">
                                                        <span class="text-lg font-bold">{{ getColumnLetter(colIndex) }}</span>
                                                        <span v-if="isColumnSelected(colIndex)" class="px-1.5 py-0.5 rounded text-[10px] bg-white/50 border border-black/10">
                                                            {{ getTypeLabel(getColumnType(colIndex)) }}
                                                        </span>
                                                    </div>
                                        ...
                                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                            <tr 
                                                ...
                                                :class="{'opacity-40 bg-gray-100 dark:bg-gray-900': (rowIndex + 1) < form.start_row, 'bg-green-50/50 dark:bg-green-900/10': (rowIndex + 1) === form.start_row}"
