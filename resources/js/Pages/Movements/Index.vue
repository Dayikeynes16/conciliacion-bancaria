...
const deleteFile = (file: { id: number }) => {
    if (confirm('¿Estás seguro de que deseas eliminar este archivo de movimientos? Se eliminarán todos los movimientos asociados. Esta acción no se puede deshacer.')) {
        router.delete(route('movements.destroy', file.id), {
            preserveScroll: true,
        });
    }
};
...
<template>
    ...
    <AuthenticatedLayout>
        <!-- ... existing content ... -->
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Movimientos Bancarios</h2>
        </template>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="flex justify-between items-center mb-6">
                            <h3 class="text-lg font-medium">Archivos de Movimientos Cargados</h3>
                        </div>
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    <tr v-for="file in files" :key="file.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer" @click="viewDetails(file)">
                                        ...
                                        <td class="py-4 px-6 truncate max-w-xs" :title="file.path">
                                            {{ file.path.split('/').pop() }}
                                        </td>
                                        <td class="py-4 px-6">
                                        ...
                                        <td class="py-4 px-6">
                                            <div class="flex items-center gap-4">
                                                ...
                                                <button @click.stop="deleteFile(file)" class="font-medium text-red-600 dark:text-red-500 hover:underline">Eliminar</button>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
            ...
            <div class="p-6">
                ...
                <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                        <li class="mr-2">
                            <a href="#" @click.prevent="activeTab = 'all'" :class="activeTab === 'all' ? 'text-blue-600 border-b-2 border-blue-600 dark:text-blue-500 dark:border-blue-500' : 'hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'" class="inline-block p-4 rounded-t-lg">
                                Todos
                            </a>
                        </li>
                        <li class="mr-2">
                            <a href="#" @click.prevent="activeTab = 'abono'" :class="activeTab === 'abono' ? 'text-green-600 border-b-2 border-green-600' : 'hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'" class="inline-block p-4 rounded-t-lg">
                                Abonos
                            </a>
                        </li>
                        <li class="mr-2">
                            <a href="#" @click.prevent="activeTab = 'cargo'" :class="activeTab === 'cargo' ? 'text-red-600 border-b-2 border-red-600' : 'hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'" class="inline-block p-4 rounded-t-lg">
                                Cargos
                            </a>
                        </li>
                    </ul>
                ...
                <div class="mt-6">
                    ...
                    <div v-else-if="filteredMovements.length === 0" class="text-center py-4 text-gray-500">
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <tr v-for="mov in filteredMovements" :key="mov.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    <td class="py-2 px-4 whitespace-nowrap">{{ new Date(mov.fecha).toLocaleDateString('es-MX') }}</td>
                                    ...
                                    <td class="py-2 px-4">
                                         <span 
                                            v-if="mov.conciliaciones_count && mov.conciliaciones_count > 0" 
                                    ...
                                    <td class="py-2 px-4 text-right font-mono" :class="mov.tipo === 'cargo' ? 'text-red-600' : 'text-green-600'">
