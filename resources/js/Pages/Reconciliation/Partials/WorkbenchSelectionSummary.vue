...
<template>
    <div
        class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6 sticky top-0 z-10 p-6 border-b border-gray-200 dark:border-gray-700"
    >
        <!-- Totals Row -->
        <div class="flex flex-wrap gap-8 mb-6">
            <div>
                <span
                    class="block text-xs text-gray-500 uppercase font-bold tracking-widest mb-1"
                    >{{ $t("FACTURAS SELECCIONADAS") }}</span
                >
                <span class="text-2xl font-bold font-mono dark:text-white">{{
            ...
            <div>
                <span
                    class="block text-xs text-gray-500 uppercase font-bold tracking-widest mb-1"
                    >{{ $t("MOVIMIENTOS SELECCIONADOS") }}</span
                >
                <span class="text-2xl font-bold font-mono dark:text-white">{{
                    formatCurrency(totalMovements)
                }}</span>
            </div>
            <div>
                <span
